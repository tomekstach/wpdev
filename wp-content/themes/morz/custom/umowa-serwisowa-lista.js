    ...
    success: function(data) {
      ...
      if (arrayLength > 0) {
        for (var i = 0; i < arrayLength; i++) {
          ...
          html += '<td><div class="vamtam-button-wrap vamtam-button-width-full"><a class="vamtam-button accent1 hover-accent6 button-solid icon-animation-disable" style="font-size: 17px; line-height: 1px; padding: 25px 40px;" role="button" href="/umowa-serwisowa-krok-4/?contract=' + data[i].id + '" target="_self"><span class="vamtam-button-text">Dokończ</span></a></div></td>';
          html += "</tr>";
        }
      }
